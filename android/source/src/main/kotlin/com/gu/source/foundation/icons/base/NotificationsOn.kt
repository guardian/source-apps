...
val Source.Icons.Base.NotificationsOn: ImageVector
    get() {
        if (_NotificationsOn != null) {
            return _NotificationsOn!!
        }
        _NotificationsOn = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(15.934f, 9.735f, 14.189f, 7.989f, 12f, 7.989f)
                curveTo(9.811f, 7.989f, 8.066f, 9.735f, 8.066f, 11.924f)
                curveTo(8.066f, 14.112f, 9.811f, 15.858f, 12f, 15.858f)
                curveTo(14.189f, 15.858f, 15.934f, 14.112f, 15.934f, 11.924f)
                close()
            }
        }.build()
...
private var _NotificationsOn: ImageVector? = null