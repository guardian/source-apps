...
val Source.Icons.Base.ShareCallout: ImageVector
    get() {
        if (_ShareCallout != null) {
            return _ShareCallout!!
        }
        _ShareCallout = ImageVector.Builder(
            name = "ShareCallout",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _ShareCallout: ImageVector? = null