...
val Source.Icons.Base.FacebookBrand: ImageVector
    get() {
        if (_FacebookBrand != null) {
            return _FacebookBrand!!
        }
        _FacebookBrand = ImageVector.Builder(
            name = "FacebookBrand",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _FacebookBrand: ImageVector? = null